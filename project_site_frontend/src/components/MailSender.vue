<template>
    <div>
        <v-row align="center" justify="center">
            <v-checkbox v-model="consentAgreed" :label="$t('gdprAgreement')"/>
        </v-row>
        <v-row align="center" justify="center">
            <vue-recaptcha @verify="(response) => recaptchaResponse = response"
                           sitekey="6LebfuAUAAAAAJI5unWoZ4IZnvMP9bqi5cSyS6Iw" class="justify-center"/>
        </v-row>
        <v-btn rounded
               class="ma-5"
               :disabled="title==='' || content==='' || sign==='' || recaptchaResponse==='' || !consentAgreed"
...
<i18n>
    ...
    "closeSnackbar":"Close",
    "gdprAgreement":"I consent to having my information processed in order to respond to my inquiry."
    },
    "pl": {
    ...
    "gdprAgreement":"Wyrażam zgodę na przetwarzanie danych zawartych w wypełnionych formularzach w celu możliwości udzielenia odpowiedzi na wysłaną wiadomość."
    }
    }
</i18n>
